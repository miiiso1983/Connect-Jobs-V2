<x-guest-layout>
    {{-- Header --}}
        ...
        <div class="relative max-w-6xl mx-auto px-4 text-center">
	            	<div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[#38BDF8]/20 flex items-center justify-center">
	                <svg class="w-8 h-8 text-[#38BDF8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
            </div>
        ...
        <div class="max-w-xl mx-auto px-4">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
	                    <a href="/" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#5B21B6] to-[#6D28D9] text-white font-bold hover:from-[#4C1D95] hover:to-[#5B21B6] transition-all duration-300 shadow-lg hover:shadow-xl">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                        العودة للرئيسية
                    </a>
	                    <a href="{{ route('jobseeker.alerts.index') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#38BDF8] text-[#4C1D95] font-bold hover:bg-[#7DD3FC] transition-all duration-300 shadow-lg hover:shadow-xl">
