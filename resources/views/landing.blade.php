<x-guest-layout>
    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-14">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0D2660]/10 dark:bg-[#0D2660]/30 text-[#0D2660] dark:text-[#E7C66A] text-sm font-medium mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl border border-gray-100 dark:border-gray-700">
                    <div class="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-[#0D2660] to-[#102E66] flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-8 h-8 text-[#E7C66A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </div>
                ...
                <div class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl border border-gray-100 dark:border-gray-700">
                    <div class="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-[#E7C66A] to-[#D2A85A] flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-8 h-8 text-[#0D2660]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                    </div>
    ...
    <!-- CTA -->
    <section class="relative overflow-hidden bg-gradient-to-br from-[#0D2660] via-[#102E66] to-[#0A1E46] text-white py-20">
        <div class="absolute -top-20 -right-20 h-72 w-72 bg-[#E7C66A]/10 rounded-full blur-3xl"></div>
        <div class="absolute -bottom-16 -left-24 h-80 w-80 bg-white/5 rounded-full blur-3xl"></div>
        <div class="relative max-w-6xl mx-auto px-4 text-center">
            <div class="w-20 h-20 mx-auto mb-6 rounded-2xl bg-[#E7C66A]/20 flex items-center justify-center">
                <svg class="w-10 h-10 text-[#E7C66A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/register?type=jobseeker" class="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#E7C66A] text-[#0D2660] font-bold text-lg hover:bg-[#D2A85A] transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    سجل كباحث عن عمل
                </a>
                <a href="/register?type=company" class="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border-2 border-[#E7C66A] text-[#E7C66A] font-bold text-lg hover:bg-[#E7C66A] hover:text-[#0D2660] transition-all duration-300 hover:-translate-y-1">
