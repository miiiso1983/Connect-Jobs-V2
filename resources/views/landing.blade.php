<x-guest-layout>
    ...
    <!-- Hero -->
	    <section class="relative overflow-hidden bg-gradient-to-br from-[#5B21B6] via-[#6D28D9] to-[#4C1D95] text-white py-20 w-full">
        ...
        <div class="relative max-w-6xl mx-auto px-4 text-center">
            ...
            <form method="GET" action="/jobs" class="max-w-2xl mx-auto flex items-stretch gap-2 bg-white/10 backdrop-blur rounded-2xl p-2">
                ...
                <input id="q" name="q" type="text" placeholder="ابحث عن مسمى وظيفي..." class="flex-1 rounded-xl bg-white/90 text-gray-800 placeholder-gray-500 px-4 py-2 focus:outline-none">
	                <button class="px-5 py-2 rounded-xl bg-gradient-to-r from-[#38BDF8] to-[#0EA5E9] text-[#4C1D95] font-semibold hover:from-[#7DD3FC] hover:to-[#38BDF8] transition">
                    ابحث
                </button>
            </form>

	            <div class="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
	                <a href="/jobs" class="px-6 py-3 rounded-xl bg-gradient-to-r from-[#38BDF8] to-[#0EA5E9] text-[#4C1D95] font-semibold hover:from-[#7DD3FC] hover:to-[#38BDF8] transition">تصفح الوظائف</a>
	                <a href="/register" class="px-6 py-3 rounded-xl border border-[#38BDF8] text-[#38BDF8] hover:bg-[#38BDF8] hover:text-[#4C1D95] transition">إنشاء حساب</a>
	            </div>
    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-14">
	                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#5B21B6]/10 dark:bg-[#5B21B6]/30 text-[#5B21B6] dark:text-[#38BDF8] text-sm font-medium mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
	                <div class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl border border-gray-100 dark:border-gray-700">
	                    <div class="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-[#5B21B6] to-[#6D28D9] flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
    ...
    <!-- CTA -->
	    <section class="relative overflow-hidden bg-gradient-to-br from-[#5B21B6] via-[#6D28D9] to-[#4C1D95] text-white py-20">
        ...
        <div class="relative max-w-6xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
	                <a href="/register?type=jobseeker" class="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#38BDF8] text-[#4C1D95] font-bold text-lg hover:bg-[#0EA5E9] transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    سجل كباحث عن عمل
                </a>
	                <a href="/register?type=company" class="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border-2 border-[#38BDF8] text-[#38BDF8] font-bold text-lg hover:bg-[#38BDF8] hover:text-[#4C1D95] transition-all duration-300 hover:-translate-y-1">
