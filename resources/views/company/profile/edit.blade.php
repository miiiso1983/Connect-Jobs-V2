<x-app-layout>
	    <x-slot name="header">
            ...
            <h2 class="text-xl font-bold">ملف الشركة</h2>
	            <p class="text-[#38BDF8] text-sm mt-1">إدارة معلومات وشعار الشركة</p>
        </div>
    </x-slot>
            ...
            {{-- Header --}}
	            <div class="flex items-center gap-3 p-6 border-b border-gray-200 dark:border-gray-700">
	                <div class="w-10 h-10 rounded-lg bg-[#5B21B6] flex items-center justify-center">
	                    <svg class="w-5 h-5 text-[#38BDF8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                </div>
            ...
            <form method="POST" action="{{ route('company.profile.update') }}" enctype="multipart/form-data" class="p-6">
                ...
                <div class="flex flex-col md:flex-row items-center gap-6 mb-8">
	                    <div class="relative group">
	                        <div class="w-28 h-28 rounded-xl overflow-hidden ring-4 ring-[#38BDF8]/30 shadow-lg">
	                        ...
	                        <div class="absolute inset-0 rounded-xl bg-[#5B21B6]/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center cursor-pointer" onclick="document.getElementById('profile_image').click()">
                ...
                {{-- Upload Section --}}
	                <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-6 text-center hover:border-[#38BDF8] transition-colors mb-6">
                    ...
                    <label for="profile_image" class="cursor-pointer">
	                        <div class="w-12 h-12 rounded-full bg-[#5B21B6]/10 dark:bg-[#38BDF8]/10 flex items-center justify-center mx-auto mb-3">
	                            <svg class="w-6 h-6 text-[#5B21B6] dark:text-[#38BDF8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
                        </div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, WebP - حتى 2MB</p>
	                        <p id="fileName" class="text-sm text-[#5B21B6] dark:text-[#38BDF8] font-medium mt-2 hidden"></p>
                    </label>
                </div>
                @error('profile_image')
                ...
                {{-- Actions --}}
                    ...
                    <a href="{{ route('dashboard') }}" class="px-6 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
	                    ...
	                    <button type="submit" class="px-6 py-3 rounded-xl bg-gradient-to-r from-[#5B21B6] to-[#6D28D9] text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5">
                        حفظ التغييرات
                    </button>
                </div>
            </form>
