<x-app-layout>
    <x-slot name="header">
            ...
            <h2 class="text-xl font-bold">لوحة تحكم الشركة</h2>
	            <p class="text-[#38BDF8] text-sm mt-1">إدارة الوظائف والمتقدمين واستعراض الإحصائيات</p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
	                <a href="{{ route('company.jobs.index') }}" class="group relative overflow-hidden p-6 rounded-xl bg-gradient-to-br from-[#5B21B6] to-[#6D28D9] text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="relative">
                        <div class="w-12 h-12 rounded-lg bg-white/10 flex items-center justify-center mb-4">
	                            <svg class="w-6 h-6 text-[#38BDF8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                        </div>
                ...
                <a href="{{ route('company.seekers.browse') }}" class="group relative overflow-hidden p-6 rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
	                ...
	                <a href="{{ route('company.jobs.create') }}" class="group relative overflow-hidden p-6 rounded-xl bg-gradient-to-br from-[#38BDF8] to-[#0EA5E9] text-[#4C1D95] shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="relative">
	                        <div class="w-12 h-12 rounded-lg bg-[#5B21B6]/10 flex items-center justify-center mb-4">
	                            <svg class="w-6 h-6 text-[#5B21B6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
                        </div>
	                ...
	                <a href="{{ route('company.applicants.index') }}" class="group relative overflow-hidden p-6 rounded-xl bg-white dark:bg-gray-800 border-2 border-[#5B21B6]/20 text-[#5B21B6] dark:text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-[#38BDF8]">
                    <div class="relative">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
	                    <div class="text-center p-4 rounded-lg bg-gradient-to-br from-[#5B21B6]/5 to-[#5B21B6]/10 dark:from-[#5B21B6]/20 dark:to-[#5B21B6]/30">
	                        <div class="text-3xl font-bold text-[#5B21B6] dark:text-[#38BDF8]">{{ $kpis['published'] ?? 0 }}</div>
                    ...
                    <div class="text-center p-4 rounded-lg bg-gradient-to-br from-emerald-500/5 to-emerald-500/10 dark:from-emerald-500/20 dark:to-emerald-500/30">
	                    ...
	                    <div class="text-center p-4 rounded-lg bg-gradient-to-br from-[#38BDF8]/10 to-[#38BDF8]/20 dark:from-[#38BDF8]/20 dark:to-[#38BDF8]/30">
	                        <div class="text-3xl font-bold text-[#5B21B6] dark:text-[#38BDF8]">{{ $kpis['avg_match'] ?? 0 }}%</div>
                        ...
                        <div class="space-y-3">
                            <template x-for="row in prov" :key="row.province">
                                <div class="flex items-center gap-3">
									...
									<div class="h-3 rounded-full bg-gradient-to-r from-[#5B21B6] to-[#6D28D9] transition-all duration-500" :style="`width: ${Math.min(100, (row.c / (prov[0]?.c||1)) * 100)}%`"></div>
                                    </div>
                        ...
                        <div class="space-y-3">
                            <template x-for="row in spec" :key="row.speciality">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1 h-3 rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden">
									<div class="h-3 rounded-full bg-gradient-to-r from-[#38BDF8] to-[#0EA5E9] transition-all duration-500" :style="`width: ${Math.min(100, (row.c / (spec[0]?.c||1)) * 100)}%`"></div>
                                    </div>
                                    <div class="w-10 text-sm font-medium text-gray-700 dark:text-gray-300" x-text="row.c"></div>
                                </div>
                            </template>
