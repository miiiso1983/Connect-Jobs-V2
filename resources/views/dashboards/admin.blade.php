<x-app-layout>
    <x-slot name="header">
        <div class="rounded-xl bg-gradient-to-br from-[#0D2660] via-[#102E66] to-[#0A1E46] text-white p-6">
            ...
            <p class="text-[#E7C66A] text-sm mt-1">إدارة الموافقات ومراجعة الوظائف والشركات</p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="{{ route('admin.pending.companies', [], false) ?? '#' }}" class="group relative overflow-hidden p-6 rounded-xl bg-gradient-to-br from-[#0D2660] to-[#1a3a7a] text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="relative">
                        <div class="w-12 h-12 rounded-lg bg-white/10 flex items-center justify-center mb-4">
                            <svg class="w-6 h-6 text-[#E7C66A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                        </div>
                ...
                <a href="{{ route('admin.companies.index') ?? '#' }}" class="group relative overflow-hidden p-6 rounded-xl bg-gradient-to-br from-[#E7C66A] to-[#D2A85A] text-[#0D2660] shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="relative">
                        <div class="w-12 h-12 rounded-lg bg-[#0D2660]/10 flex items-center justify-center mb-4">
                            <svg class="w-6 h-6 text-[#0D2660]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"/></svg>
                        </div>
                        <div class="text-sm opacity-80">الشركات</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="{{ route('admin.jobs.index') ?? '#' }}" class="group relative overflow-hidden p-6 rounded-xl bg-white dark:bg-gray-800 border-2 border-[#0D2660]/20 text-[#0D2660] dark:text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-[#E7C66A]">
                    <div class="relative">
                ...
                <a href="{{ route('admin.districts.index') ?? '#' }}" class="group relative overflow-hidden p-6 rounded-xl bg-white dark:bg-gray-800 border-2 border-[#0D2660]/20 text-[#0D2660] dark:text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-[#E7C66A]">
                    <div class="relative">
                        <div class="w-12 h-12 rounded-lg bg-[#0D2660]/10 dark:bg-[#E7C66A]/10 flex items-center justify-center mb-4">
                ...
                <a href="{{ route('admin.settings.index') ?? '#' }}" class="group relative overflow-hidden p-6 rounded-xl bg-white dark:bg-gray-800 border-2 border-[#0D2660]/20 text-[#0D2660] dark:text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-[#E7C66A]">
                    <div class="relative">
                        <div class="w-12 h-12 rounded-lg bg-[#0D2660]/10 dark:bg-[#E7C66A]/10 flex items-center justify-center mb-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-10 h-10 rounded-lg bg-[#E7C66A] flex items-center justify-center">
                        <svg class="w-5 h-5 text-[#0D2660]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    </div>
