    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="{{ route('jobs.index') }}" class="group p-6 rounded-xl bg-gradient-to-br from-sky-500 to-indigo-600 text-white shadow hover:shadow-lg">
                ...
                <a href="{{ route('jobseeker.profile.edit') }}" class="group p-6 rounded-xl bg-gradient-to-br from-emerald-500 to-green-600 text-white shadow hover:shadow-lg">
                ...
                <a href="{{ route('notifications.index') }}" class="group p-6 rounded-xl bg-gradient-to-br from-pink-500 to-rose-600 text-white shadow hover:shadow-lg">
