<x-app-layout>
    <x-slot name="header">
        <div class="rounded-xl bg-gradient-to-br from-[#0D2660] via-[#102E66] to-[#0A1E46] text-white p-6">
            ...
            <p class="text-[#E7C66A] text-sm mt-1">ابدأ رحلتك المهنية واكتشف الفرص المناسبة لك</p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="{{ route('jobs.index') }}" class="group relative overflow-hidden p-6 rounded-xl bg-gradient-to-br from-[#0D2660] to-[#1a3a7a] text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <a href="{{ route('jobseeker.profile.edit') }}" class="group relative overflow-hidden p-6 rounded-xl bg-gradient-to-br from-[#E7C66A] to-[#D2A85A] text-[#0D2660] shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="relative">
                        <div class="w-12 h-12 rounded-lg bg-[#0D2660]/10 flex items-center justify-center mb-4">
                            <svg class="w-6 h-6 text-[#0D2660]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        </div>
                ...
                <a href="{{ route('notifications.index') }}" class="group relative overflow-hidden p-6 rounded-xl bg-white dark:bg-gray-800 border-2 border-[#0D2660]/20 text-[#0D2660] dark:text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-[#E7C66A]">
                    <div class="relative">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="flex items-start gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                        <span class="flex-shrink-0 w-8 h-8 rounded-full bg-[#0D2660] text-white flex items-center justify-center text-sm font-bold">1</span>
                        <div>
                    ...
                    <div class="flex items-start gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                        <span class="flex-shrink-0 w-8 h-8 rounded-full bg-[#E7C66A] text-[#0D2660] flex items-center justify-center text-sm font-bold">2</span>
                        <div>
                    ...
                    <div class="flex items-start gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                        <span class="flex-shrink-0 w-8 h-8 rounded-full bg-[#0D2660] text-white flex items-center justify-center text-sm font-bold">3</span>
                        <div>
