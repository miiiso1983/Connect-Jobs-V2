...
<?php unset($__componentOriginalc295f12dca9d42f28a259237a5724830); ?>
<?php endif; ?>
                    <?php if(auth()->check() && (auth()->user()->role ?? null)==='admin'): ?>
                        <?php if (isset($component)) { $__componentOriginalc295f12dca9d42f28a259237a5724830 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc295f12dca9d42f28a259237a5724830 = $attributes; } ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc295f12dca9d42f28a259237a5724830 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc295f12dca9d42f28a259237a5724830 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('admin.districts.index'),'active' => request()->routeIs('admin.districts.*')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.districts.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('admin.districts.*'))]); ?>
                            إدارة المناطق
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc295f12dca9d42f28a259237a5724830)): ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '80']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            <button class="relative inline-flex items-center justify-center w-9 h-9 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <?php if($unread>0): ?>
                                    <span class="absolute -top-1 -right-1 text-[10px] px-1.5 py-0.5 rounded-full bg-red-600 text-white"><?php echo e($unread); ?></span>
                                <?php endif; ?>
                            </button>
                         <?php $__env->endSlot(); ?>
                         <?php $__env->slot('content', null, []); ?> 
                            <div class="px-4 py-2 text-sm font-semibold text-gray-700 dark:text-gray-200"><?php echo e(__('nav.notifications')); ?></div>
                            <div class="max-h-80 overflow-y-auto divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="px-4 py-2">
                                        <div class="font-medium text-gray-800 dark:text-gray-100"><?php echo e(data_get($n->data,'title')); ?></div>
                                        <div class="text-xs text-gray-600 dark:text-gray-300"><?php echo e(data_get($n->data,'message')); ?></div>
                                        <div class="mt-1 flex items-center justify-between text-[11px] text-gray-400">
                                            <span><?php echo e($n->created_at->diffForHumans()); ?></span>
                                            <?php if(is_null($n->read_at)): ?>
                                            <form method="POST" action="<?php echo e(route('notifications.read',$n->id)); ?>">
                                                <?php echo csrf_field(); ?>
                                                <button class="text-indigo-600 dark:text-indigo-400 hover:underline"><?php echo e(__('notifications.mark_read')); ?></button>
                                            </form>
                                            <?php else: ?>
                                                <span><?php echo e(__('notifications.read')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <div class="px-4 py-2 text-sm text-gray-500"><?php echo e(__('notifications.none')); ?></div>
                                <?php endif; ?>
                            </div>
                            <div class="px-4 py-2 flex items-center justify-between">
                                <a class="text-indigo-600 dark:text-indigo-400 text-sm hover:underline" href="<?php echo e(route('notifications.index')); ?>"><?php echo e(__('notifications.view_all')); ?></a>
                                <form method="POST" action="<?php echo e(route('notifications.read_all')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button class="text-xs text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"><?php echo e(__('notifications.mark_all_read')); ?></button>
                                </form>
                            </div>
                         <?php $__env->endSlot(); ?>
                     <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
                ...
                <div class="hidden sm:flex items-center gap-2 ms-6">
                    <a href="<?php echo e(route('locale.switch','en')); ?>" class="text-sm <?php echo e(app()->getLocale()==='en'?'font-bold':''); ?>">EN</a>
                    <span class="text-gray-400">|</span>
                    <a href="<?php echo e(route('locale.switch','ar')); ?>" class="text-sm <?php echo e(app()->getLocale()==='ar'?'font-bold':''); ?>">AR</a>
                    <span class="text-gray-400">|</span>
                    <a href="<?php echo e(route('locale.switch','ku')); ?>" class="text-sm <?php echo e(app()->getLocale()==='ku'?'font-bold':''); ?>">KU</a>
                </div>
                <!-- Theme Switcher -->
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div><?php echo e(Auth::user()->name ?? __('nav.profile')); ?></div>
...
<?php /**PATH /Users/mustafaaljaf/Documents/augment-projects/Connect Job V2/app/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>